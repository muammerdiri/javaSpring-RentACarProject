...
public class HPVExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(HPVDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new HPVStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static HPVDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static HPVDateTimeConverter dateTimeConverter = new HPVStandardDateTimeConverter();

    public HPVExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public HPVExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new HPVMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=HPVHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,HPVExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=HPVHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
