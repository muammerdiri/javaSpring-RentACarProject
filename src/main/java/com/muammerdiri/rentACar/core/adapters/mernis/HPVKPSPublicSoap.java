package com.muammerdiri.rentACar.core.adapters.mernis;
...
public class HPVKPSPublicSoap
{
    interface HPVIWcfMethod
    {
        HPVExtendedSoapSerializationEnvelope CreateSoapEnvelope() throws java.lang.Exception;

        java.lang.Object ProcessResult(HPVExtendedSoapSerializationEnvelope __envelope,java.lang.Object result) throws java.lang.Exception;
    }
    ...
    public HPVKPSPublicSoap(){}

    public HPVKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public HPVKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    protected HPVExtendedSoapSerializationEnvelope createEnvelope()
    {
        HPVExtendedSoapSerializationEnvelope envelope= new HPVExtendedSoapSerializationEnvelope(HPVExtendedSoapSerializationEnvelope.VER11);
        envelope.enableLogging = enableLogging;
    
        return envelope;
    }

    protected java.util.List sendRequest(String methodName,HPVExtendedSoapSerializationEnvelope envelope,org.ksoap2.transport.Transport transport ,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile )throws java.lang.Exception
    {
    ...
    java.lang.Object getResult(java.lang.Class destObj,java.lang.Object source,String resultName,HPVExtendedSoapSerializationEnvelope __envelope) throws java.lang.Exception
    {
        if(source==null)
        {
            return null;
    ...
    public Boolean TCKimlikNoDogrula(final Long TCKimlikNo,final String Ad,final String Soyad,final Integer DogumYili) throws java.lang.Exception
    {
        ...
        return (Boolean)execute(new HPVIWcfMethod()
        {
            @Override
            public HPVExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                HPVExtendedSoapSerializationEnvelope __envelope = createEnvelope();
            ...
            @Override
            public java.lang.Object ProcessResult(HPVExtendedSoapSerializationEnvelope __envelope,java.lang.Object __result)throws java.lang.Exception {
    ...
    protected java.lang.Object execute(HPVIWcfMethod wcfMethod,String methodName,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws java.lang.Exception
    {
        org.ksoap2.transport.Transport __httpTransport=createTransport();
        __httpTransport.debug=enableLogging;
        HPVExtendedSoapSerializationEnvelope __envelope=wcfMethod.CreateSoapEnvelope();
        try
        {
    ...
    protected java.lang.Exception convertToException(org.ksoap2.SoapFault fault,HPVExtendedSoapSerializationEnvelope envelope)
    {
    ...
    public static class UserController {
        ...
        public Result add(@RequestBody User user) throws Exception {
            boolean success = userService.add(user).isSuccess();

            if (success){
                userService.add(user);
                return new SuccessResult("User is successly added.");
            }
            return new ErrorResult("Add user failed! ");
        }

        @DeleteMapping("/delete")
        public Result delete(@RequestBody User user){
            boolean success = userService.delete(user).isSuccess();
            if (success){
                userService.delete(user);
                return new SuccessResult("User is successly deleted.");
            }
            return new ErrorResult("Delete user failed! ");
        }


        @GetMapping("/getall")
        public DataResult<List<User>> getAll(){
            boolean success = !userService.getAll().isEmpty();
            if (success){
                return new SuccessDataResult<List<User>>(userService.getAll(),"User is successly Listed.");
            }
            return new ErrorDataResult<List<User>>("Listed user failed! ");
        }
