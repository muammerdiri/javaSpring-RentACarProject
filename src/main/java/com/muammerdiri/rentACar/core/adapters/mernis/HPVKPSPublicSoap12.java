...
public class HPVKPSPublicSoap12
{
    ...
    public HPVKPSPublicSoap12(){}

    public HPVKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public HPVKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        HPVExtendedSoapSerializationEnvelope envelope= new HPVExtendedSoapSerializationEnvelope(HPVExtendedSoapSerializationEnvelope.VER12);
